...
pub enum OpCode {
    // variable management
    CreateLocal { dtype: DataType, name: String },
    CreateGlobal { dtype: DataType, name: String },
    DeleteLocal { name: String },
    SetVar { dest: String, value: Operand },
    CopyVar { dest: String, source: String },

    // memory management
    Alloc { dest: String, size: Operand },
    Free { ptr: String },
    Load { dest: String, ptr: String, dtype: DataType },
    Store {ptr: String, source: String, dtype: DataType },
    GetAddr { dest: String, var: String },
    ...
    Neg { dest: String, source: Operand },
    ...
    Not { dest: String, source: Operand },
    ...
    Jnz { var: String, label: String },

    // function operations
    FuncBegin { name: String, return_type: DataType },
    FuncEnd,
    ...
    // type conversion
    Cast { dest: String, source: String, target_type: DataType },
